...
public class ConfirmMemberDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE, "积分",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dismiss();
                        if (onDialogSure != null) {
                            onDialogSure.integral();
                        }
                    }
                });
        dialog.setButton(DialogInterface.BUTTON_NEUTRAL, "卡券",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dismiss();
