...
public class Print {
    private BaseRepertory baseRepertory;

    public Print(BaseRepertory baseRepertory) {
...
//
    ...
    private void update(String id,String ip){
        baseRepertory.updatePrint("7",id,ip).subscribe(new Consumer<BaseEntity<String>>() {
            @Override
