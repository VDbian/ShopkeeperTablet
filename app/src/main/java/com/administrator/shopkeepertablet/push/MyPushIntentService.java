    ...
    public void onMessage(Context context, Intent intent) {
        try {
            ...
            if (msg.display_type.equals("notification")) {
                ...
                PushHelper.notify(context, msg, new BaseRepertoryImpl(AppApplication.get(context).getAppComponent().getApiSource(),AppApplication.get(context).getAppComponent().getPreferenceSource()));
